...
namespace llvm {
  ...
  public:
	...
	bool is2048BitVector() const {
		return (SimpleTy == MVT::dspvi32|| SimpleTy == MVT::dspvi16|| SimpleTy == MVT::dspvi8);//ppp
	}
    ...
    unsigned getVectorNumElements() const {
      ...
      default:
        llvm_unreachable("Not a vector MVT!");
	  case dspvi16: return 128;//ppp
	  case dspvi8: return 256;//
      case v32i1:
      case v32i8:
    ...
    static MVT getVectorVT(MVT VT, unsigned NumElements) {
      ...
      case MVT::i8:
		...
		if (NumElements == 256) return MVT::dspvi8;//ppp
        break;
      case MVT::i16:
		...
		if (NumElements == 128) return MVT::dspvi16;//
        break;
      case MVT::i32:
		...
		if (NumElements == 64) return MVT::dspvi32;//
        break;
      case MVT::i64:
