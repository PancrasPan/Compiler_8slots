...
void ASTWriter::WriteInputFiles(SourceManager &SourceMgr,
  ...
  Stream.EmitRecordWithBlob(OffsetsAbbrevCode, Record, (char*)data(InputFileOffsets));
}
...
void ASTWriter::WriteSourceManagerBlock(SourceManager &SourceMgr,
  ...
  Stream.EmitRecordWithBlob(SLocOffsetsAbbrev, Record, (char*)data(SLocEntryOffsets));
...
uint64_t ASTWriter::WriteDeclContextLexicalBlock(ASTContext &Context,
  ...
  Stream.EmitRecordWithBlob(DeclContextLexicalAbbrev, Record, (char*)data(Decls));
  return Offset;
}
...
void ASTWriter::WriteTypeDeclOffsets() {
  ...
  Stream.EmitRecordWithBlob(TypeOffsetAbbrev, Record, (char*)data(TypeOffsets));
  ...
  Stream.EmitRecordWithBlob(DeclOffsetAbbrev, Record, (char*)data(DeclOffsets));
}
