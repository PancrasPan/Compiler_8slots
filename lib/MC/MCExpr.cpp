...
StringRef MCSymbolRefExpr::getVariantKindName(VariantKind Kind) {
  ...
  case VK_DSP_GPREL: return "GPREL";
  case VK_DSP_GOT_CALL: return "GOT_CALL";
  case VK_DSP_GOT16: return "GOT16";
  case VK_DSP_GOT: return "GOT";
  case VK_DSP_ABS_HI: return "ABS_HI";
  case VK_DSP_ABS_LO: return "ABS_LO";
  case VK_DSP_TLSGD: return "TLSGD";
  case VK_DSP_TLSLDM: return "TLSLDM";
  case VK_DSP_DTP_HI: return "DTP_HI";
  case VK_DSP_DTP_LO: return "DTP_LO";
  case VK_DSP_GOTTPREL: return "GOTTPREL";
  case VK_DSP_TP_HI: return "TP_HI";
  case VK_DSP_TP_LO: return "TP_LO";
  case VK_DSP_GPOFF_HI: return "GPOFF_HI";
  case VK_DSP_GPOFF_LO: return "GPOFF_LO";
  case VK_DSP_GOT_DISP: return "GOT_DISP";
  case VK_DSP_GOT_PAGE: return "GOT_PAGE";
  case VK_DSP_GOT_OFST: return "GOT_OFST";
  case VK_DSP_HIGHER: return "HIGHER";
  case VK_DSP_HIGHEST: return "HIGHEST";
  case VK_DSP_GOT_HI16: return "GOT_HI16";
  case VK_DSP_GOT_LO16: return "GOT_LO16";
  case VK_DSP_CALL_HI16: return "CALL_HI16";
  case VK_DSP_CALL_LO16: return "CALL_LO16";
