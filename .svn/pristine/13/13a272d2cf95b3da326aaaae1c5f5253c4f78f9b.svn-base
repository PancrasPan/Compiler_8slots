...
StringRef getELFRelocationTypeName(uint32_t Machine, uint32_t Type) {
  ...
  case ELF::EM_DSP: // llvm-objdump -t -r
	  switch (Type) {
		  LLVM_ELF_SWITCH_RELOC_TYPE_NAME(R_DSP_NONE);
		  LLVM_ELF_SWITCH_RELOC_TYPE_NAME(R_DSP_32);
		  LLVM_ELF_SWITCH_RELOC_TYPE_NAME(R_DSP_HI16);
		  LLVM_ELF_SWITCH_RELOC_TYPE_NAME(R_DSP_LO16);
		  LLVM_ELF_SWITCH_RELOC_TYPE_NAME(R_DSP_GPREL16);
		  LLVM_ELF_SWITCH_RELOC_TYPE_NAME(R_DSP_LITERAL);
		  LLVM_ELF_SWITCH_RELOC_TYPE_NAME(R_DSP_GOT16);
		  LLVM_ELF_SWITCH_RELOC_TYPE_NAME(R_DSP_PC16);
		  LLVM_ELF_SWITCH_RELOC_TYPE_NAME(R_DSP_PC24);
		  LLVM_ELF_SWITCH_RELOC_TYPE_NAME(R_DSP_CALL16);
		  LLVM_ELF_SWITCH_RELOC_TYPE_NAME(R_DSP_GOT_HI16);
		  LLVM_ELF_SWITCH_RELOC_TYPE_NAME(R_DSP_GOT_LO16);
		  LLVM_ELF_SWITCH_RELOC_TYPE_NAME(R_DSP_RELGOT);
		  LLVM_ELF_SWITCH_RELOC_TYPE_NAME(R_DSP_TLS_GD);
		  LLVM_ELF_SWITCH_RELOC_TYPE_NAME(R_DSP_TLS_LDM);
		  LLVM_ELF_SWITCH_RELOC_TYPE_NAME(R_DSP_TLS_DTP_HI16);
		  LLVM_ELF_SWITCH_RELOC_TYPE_NAME(R_DSP_TLS_DTP_LO16);
		  LLVM_ELF_SWITCH_RELOC_TYPE_NAME(R_DSP_TLS_GOTTPREL);
		  LLVM_ELF_SWITCH_RELOC_TYPE_NAME(R_DSP_TLS_TPREL32);
		  LLVM_ELF_SWITCH_RELOC_TYPE_NAME(R_DSP_TLS_TP_HI16);
		  LLVM_ELF_SWITCH_RELOC_TYPE_NAME(R_DSP_TLS_TP_LO16);
		  LLVM_ELF_SWITCH_RELOC_TYPE_NAME(R_DSP_GLOB_DAT);
		  LLVM_ELF_SWITCH_RELOC_TYPE_NAME(R_DSP_JUMP_SLOT);
	  default:
		  break;
	  }
	  break;
