...
std::string EVT::getEVTString() const {
  ...
  case MVT::dspvi32:   return "dspvi32";//ppp
  case MVT::dspvi16:   return "dspvi16";
  case MVT::dspvi8:   return "dspvi8";
...
Type *EVT::getTypeForEVT(LLVMContext &Context) const {
  ...
  case MVT::dspvi32:   return VectorType::get(Type::getInt32Ty(Context), 64);//ppp
  case MVT::dspvi16:   return VectorType::get(Type::getInt16Ty(Context), 128);
  case MVT::dspvi8:   return VectorType::get(Type::getInt8Ty(Context), 256);
