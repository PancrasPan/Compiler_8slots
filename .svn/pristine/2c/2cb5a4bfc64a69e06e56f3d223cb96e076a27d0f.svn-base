...
Value *CodeGenFunction::EmitDSPBuiltinExpr(unsigned BuiltinID,
	...
	case DSP::BI__builtin_dsp_vltl: {
		Value *F = CGM.getIntrinsic(Intrinsic::dsp_vltl);
		return Builder.CreateCall(F);
	}
	case DSP::BI__builtin_dsp_vlth: {
		Value *F = CGM.getIntrinsic(Intrinsic::dsp_vlth);
		return Builder.CreateCall(F);
	}
	//
	case DSP::BI__builtin_dsp_movg2v_40: {
		Value *F = CGM.getIntrinsic(Intrinsic::dsp_movg2v_40);
		return Builder.CreateCall(F);
	}
	case DSP::BI__builtin_dsp_movg2v_20: {
		Value *F = CGM.getIntrinsic(Intrinsic::dsp_movg2v_20);
		return Builder.CreateCall(F);
	}
	case DSP::BI__builtin_dsp_movg2v_10: {
		Value *F = CGM.getIntrinsic(Intrinsic::dsp_movg2v_10);
		return Builder.CreateCall(F);
	}
	case DSP::BI__builtin_dsp_movv2g_40: {
		Value *F = CGM.getIntrinsic(Intrinsic::dsp_movv2g_40);
		return Builder.CreateCall(F);
	}
	case DSP::BI__builtin_dsp_movv2g_20: {
		Value *F = CGM.getIntrinsic(Intrinsic::dsp_movv2g_20);
		return Builder.CreateCall(F);
	}
	case DSP::BI__builtin_dsp_movv2g_10: {
		Value *F = CGM.getIntrinsic(Intrinsic::dsp_movv2g_10);
		return Builder.CreateCall(F);
	}
	case DSP::BI__builtin_dsp_movl2v: {
		Value *F = CGM.getIntrinsic(Intrinsic::dsp_movl2v);
		return Builder.CreateCall(F);
	}
	case DSP::BI__builtin_dsp_movv2l: {
		Value *F = CGM.getIntrinsic(Intrinsic::dsp_movv2l);
		return Builder.CreateCall(F);
	}
	case DSP::BI__builtin_dsp_movv2v: {
		Value *F = CGM.getIntrinsic(Intrinsic::dsp_movv2v);
		return Builder.CreateCall(F);
	}
	case DSP::BI__builtin_dsp_vmovg2v_10: {
		Value *F = CGM.getIntrinsic(Intrinsic::dsp_vmovg2v_10);
		return Builder.CreateCall(F);
	}
	case DSP::BI__builtin_dsp_vmovg2v_20: {
		Value *F = CGM.getIntrinsic(Intrinsic::dsp_vmovg2v_20);
		return Builder.CreateCall(F);
	}
	case DSP::BI__builtin_dsp_vmovg2v_40: {
		Value *F = CGM.getIntrinsic(Intrinsic::dsp_vmovg2v_40);
		return Builder.CreateCall(F);
	}
	case DSP::BI__builtin_dsp_trap:{
		Value *F =CGM.getIntrinsic(Intrinsic::dsp_trap);
		return Builder.CreateCall(F);
	}
	default:
		return nullptr;
